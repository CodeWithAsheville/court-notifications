    ...
    <div className="App">
      <ol className="usa-process-list">
        <li className="usa-process-list__item">
          <h4 className="usa-process-list__heading" ref={step1}>Search For Your Case</h4>
        ...
        <li className="usa-process-list__item">
          <h4 className="usa-process-list__heading" ref={step2}>Copy Your File Number</h4>
          <p>Once you find your case, click the copy button</p>
          <CaseTable cases={state.cases} dispatch={dispatch} />
        </li>
        <li className="usa-process-list__item">
          <h4 className="usa-process-list__heading" ref={step3}>Sign Up For Notifications</h4>
          <p>
