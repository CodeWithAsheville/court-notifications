...
exports.up = async function (knex) {
  const msg = `<p>The Buncombe County Court System will transition to a new electronic record-keeping system July 22. Court Reminders will return on July 23. People already signed up will continue to receive notifications.</p>
    <p>El sistema judicial del condado de Buncombe hará la transición a un nuevo sistema de mantenimiento de registros electrónicos el 22 de julio. Los recordatoriosorios judiciales volverán el 23 de julio. Las personas que ya se hayan registrado seguirán recibiendo notificaciones.</p>
