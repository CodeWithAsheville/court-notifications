...
export default function Footer() {
  ...
  let privacyStatementWithoutLinks = 'https://docs.google.com/document/d/1YitpkjO2aJH2zwQ_m_Hx6NbhJHqK1q6g0OTKJkxeXAY/';
          ...
          <div className="usa-footer__logo grid-row grid-gap-2">
            <div className="grid-col-auto">
              ...
              <div style={{textAlign: "center", width: "100%"}}>
                ...
                <span style={{paddingRight: "2em"}}>
                  <a href={isJailVersion ? privacyStatementWithoutLinks : privacyStatementWithLinks} rel="noreferrer" target="_blank">{t('footer.privacy-policy')}</a>
                </span>
                {!isJailVersion && (
                <span>
